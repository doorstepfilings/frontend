                                      ...
                                      {SLOT_TIMES.map((slot) => {
                                          ...
                                          return (
                                              <button
                                                  ...
                                                  className={`rounded-xl border-2 py-3 px-2 text-xs font-bold transition-all ${
