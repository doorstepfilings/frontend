  ...
  return (
    ...
    >
      ...
      >
        ...
        <motion.div
          className="absolute rounded-full border-2 border-transparent border-r-blue-200 border-t-blue-600"
          style={{
...
export function PageLogoLoader({
  ...
  return (
    <div
      className={`flex min-h-[70vh] lg:min-h-[80vh] w-full items-center justify-center px-4 py-10 ${className}`}
    >
      <LoaderSurface className={`w-full max-w-md ${surfaceClassName}`}>
        <LogoLoader size={size} label={label} />
      </LoaderSurface>
