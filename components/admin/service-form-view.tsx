...
export function ServiceFormView() {
  ...
  return (
      <AuthGuard allowedRoles={["super_admin"]}>
        <AdminLayout>
          <div className="panel-page max-w-[82rem]">
                ...
                <div className="space-y-8 px-5 py-6 sm:px-6 sm:py-7">
                    ...
                    <div className="grid gap-5 lg:grid-cols-12">
                      ...
                      >
                        <SearchSelect
                          ...
                          triggerClassName="h-12 rounded-[1.15rem] px-4 py-3"
                    ...
                    {showPlans ? (
                      <DynamicList
                        ...
                        renderItem={(plan, index) => (
                          <div className="space-y-5 rounded-[1.5rem] border border-slate-200 bg-slate-50 p-4 sm:p-5">
                  ...
                  <section className="space-y-6">
                    ...
                    <DynamicList
                      ...
                      renderItem={(document, index) => (
                        <div className="space-y-4 rounded-[1.5rem] border border-slate-200 bg-slate-50 p-4 sm:p-5">
                  ...
                  <div className="flex flex-col gap-3 border-t border-slate-200 pt-6 sm:flex-row">
                    <button
                      type="submit"
                      disabled={saving}
                      className="admin-btn h-12 min-w-[11rem] rounded-2xl text-xs flex items-center justify-center gap-2 disabled:cursor-not-allowed disabled:opacity-60"
                    >
                      {saving ? (
                        <Loader2 className="h-4 w-4 animate-spin" aria-hidden="true" />
                      ) : (
                    ...
                    <Link
                      href="/admin/services"
                      className="admin-btn-muted h-12 min-w-[9rem] rounded-2xl text-xs flex items-center justify-center"
                    >
                      Cancel
                    </Link>
                  </div>
                ...
                {isEditMode ? (
                  ...
                  <div className="rounded-[1.5rem] border border-dashed border-slate-200 bg-slate-50 px-4 py-8 text-center">
                    <p className="text-sm font-medium text-slate-600">
                      Save the service first to configure milestones.
                    </p>
                  </div>
                )}
              </div>
...
function CurrencyInput({
  ...
  return (
    <div className="flex min-w-0 overflow-hidden rounded-[1.15rem] border border-slate-200 bg-white transition focus-within:border-blue-600 focus-within:ring-4 focus-within:ring-blue-500/10">
...
function CompactToggle({
  ...
  return (
    <button
      ...
      className="flex h-12 w-full items-center justify-between gap-4 rounded-[1.15rem] border border-slate-200 bg-slate-50 px-4 text-left transition hover:border-blue-200 hover:bg-white sm:px-5"
    >
