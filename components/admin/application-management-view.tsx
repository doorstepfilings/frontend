                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                            <div className="flex items-center gap-2">
                                <label className="relative">
                                    <i className="fas fa-calendar-day absolute left-4 top-1/2 -translate-y-1/2 text-slate-400"></i>
                                    <input
                                        type="date"
                                        aria-label="Filter applications by date"
                                        value={applicationDate}
                                        onChange={(event) => setApplicationDate(event.target.value)}
                                        className="h-11 min-w-[190px] rounded-xl border border-slate-200 bg-white pl-10 pr-3 text-sm font-semibold text-slate-700 shadow-sm transition-all focus:border-blue-500/40 focus:outline-none focus:ring-2 focus:ring-blue-500/10"
                                    />
                                </label>
                                {applicationDate && (
                                    <button
                                        ...
                                        className="h-11 rounded-xl border border-slate-200 bg-white px-4 text-[10px] font-black uppercase tracking-wider text-slate-500 transition-colors hover:border-red-200 hover:bg-red-50 hover:text-red-600"
                                    >
                                        Clear
                                    </button>
                                )}
                                    ...
                                    {loading ? (
                                        ...
                                        return (
                                            <tr key={app.id} className="hover:bg-blue-50/20 transition-all group">
                                                ...
                                                <td className="px-6 py-6">
                                                    <div className="text-xs font-bold text-slate-700">{applicationCreatedAt.date}</div>
                                                    {applicationCreatedAt.time && (
                                                        <div className="mt-1 text-[10px] font-medium text-slate-400">{applicationCreatedAt.time}</div>
                                                    )}
                                                </td>
